...
function Home() {
    ...
    const categoryID = "663885c976fc79096e24485e";
  ...
  return (
    <div>
        ...
        <div className="relative mb-20 flex flex-row gap-[60px] ">
            
            <div className="absolute translate-x-[-150%] w-80 h-20 mt-5  bg-richblack-900 flex justify-center items-center border-2 rounded-lg border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]" >
                <div className="font-bold ">
                Expanding minds with 
            ...
            <div className="group mt-8  p-1 mx-auto rounded-full bg-richblack-700  font-bold text-richblack-100
            transition-all duration-200 hover:scale-95 w-fit translate-x-[180%]">
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                ...
                <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                    ...
                    The modern TechGrasp is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                    </div>
                    <CTAButton active={true} linkto={"/signup"}>
                        <div>
                            Learn more
